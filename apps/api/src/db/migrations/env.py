...
Supports:
  ...
  - Multi-schema: core, data, iot
  - include_schemas=True so autogenerate detects schema-qualified tables
"""
import asyncio
...
from src.db.base import target_metadata  # noqa: F401
...
def include_object(object, name, type_, reflected, compare_to):  # noqa: A002
    """Only autogenerate objects in our managed schemas."""
    if type_ == "table":
        return object.schema in SCALD_SCHEMAS
    if type_ == "schema":
        return name in SCALD_SCHEMAS
    return True
